...
class Model_layer(nn.Module):
    def __init__(self,input_size,effect_size,output_size,output_length,nlayers_1,nlayers_2, hidden_size_1 = 60, hidden_size_2 = 60):
        ...
        self.relation_4 = Relation(input_size, effect_size, nlayers_1, hidden_size_1)
        self.relation_5 = Relation(input_size, effect_size, nlayers_1, hidden_size_1)
        self.r_type_dict = {1: self.relation_1, 2: self.relation_1, 3: self.relation_3, 4: self.relation_4, 5: self.relation_5}
    ...
    def forward(self,en_att_1,en_att_2,en_att_3,en_att_4,rs_12,rr_12,rs_23,rr_23,rs_34,rr_34,r_type_12,r_type_23,r_type_34):
        '''
        ...
        en_att_4 = torch.permute(en_att_4, (1, 2, 0, 3))
        n_entities_1l, seq_len, batch_size, n_en_att = en_att_1.shape
        n_entities_2l, _, _, _ = en_att_2.shape
        ...
        effect2_zores = torch.zeros(n_entities_2l-len(effect2), seq_len, batch_size, self.effect_size)
        effect2 = torch.cat((effect2_zores,effect2),0)
        x2 = self.m_interacetion_seg(en_att_2, en_att_3, rs_23, rr_23, effect2)
        effect3 = self.effect_cal(x2, r_type_23, seq_len, batch_size)
        x3 = self.m_interacetion_seg(en_att_3, en_att_4, rs_34, rr_34, effect3)
        effect3 = self.effect_cal(x3, r_type_34, seq_len, batch_size)
