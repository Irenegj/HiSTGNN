...
class Model_layer(nn.Module):
    ...
    def forward(self,en_att_1,en_att_2,en_att_3,rs_12,rr_12,rs_23,rr_23,r_type_12,r_type_23):
        ...
        :param rr_23: [n_relations_1l-2l,seq_len,batch_size,n_entities_3l]
        ...
        # print(en_att_1.shape)
        # print(en_att_2.shape)
        # print(en_att_3.shape)
        ...
        '''effect1: [n_entities_1l,seq_len,batch_size,effect_size]'''
        x1 = self.m_interacetion_seg(en_att_1,en_att_2,rs_12,rr_12,effect1)
        '''x1: [n_relations_1l-2l,seq_len,batch_size,2*n_en_att+effect_size]'''
        # 计算第1-2层影响
        # for h in x1:
        #     print(h)
        # print("整合后的第一层12个关系：")
        ...
        # print(effect2)
        '''effect2: [n_entities_2l,seq_len,batch_size,effect_size]'''
        # 准备第2-3层输入
        # print("第一层聚合后的影响：")
        # print(effect2)
        ...
        # print(x2[:,:,0,:])
        # print(x2)
        '''x2: [n_relations_2l-3l,seq_len,batch_size,2*n_en_att+effect_size]'''
        # 计算第2-3层影响
        effect3 = self.effect_cal(x2, r_type_23, seq_len, batch_size)
        # print("第三层聚合后的影响：")
        # print(effect3)
        '''effect3: [1,seq_len,batch_size,effect_size]'''
        # 计算生存概率
        # print(effect3.shape)
